...
export const profile = {
  ...
  about:
    "Saya berpengalaman membangun landing page, website internal, dashboard admin, dan aplikasi berbasis kebutuhan bisnis. Kekuatan saya ada pada penerjemahan desain UI/UX menjadi interface responsif, kolaborasi dengan tim, dokumentasi alur sistem, serta validasi fitur agar produk tetap stabil dan mudah digunakan.",
};

export const metrics = [
  { value: "2025", label: "Lulus S.Kom." },
  { value: "3.49", label: "GPA Universitas Gunadarma" },
  { value: "2025", label: "Front-End Developer aktif" },
  { value: "8+", label: "Project web dan sistem" },
];
...
export const experiences: Experience[] = [
  {
    ...
    location: "Jakarta",
    summary:
      "Mengembangkan landing page dan antarmuka aplikasi berdasarkan kebutuhan bisnis serta desain UI/UX.",
    points: [
  ...
  },
  {
    ...
    location: "Depok",
    summary:
      "Menganalisis kebutuhan bisnis dan menerjemahkannya menjadi alur sistem untuk aplikasi rekrutmen.",
    points: [
    ...
    stack: ["Postman", "Draw.io", "Dokumentasi API", "User Guide"],
  },
  {
    ...
    location: "Depok",
    summary:
      "Memimpin tim pengembangan teknologi informasi untuk website kegiatan fakultas dan sistem organisasi.",
    points: [
  ...
  },
  {
    ...
    location: "Depok",
    summary:
      "Mengembangkan website pendukung kegiatan organisasi dan dokumentasi teknis proyek.",
    points: [
...
export const projects: Project[] = [
  {
    ...
    summary:
      "Antarmuka web pemerintahan yang responsif dengan integrasi API untuk kebutuhan operasional sistem.",
    points: [
  ...
  },
  {
    ...
    stack: ["Node.js", "Flutter", "Vue.js", "Figma", "REST API"],
    summary:
      "Sistem rekrutmen end-to-end dengan mobile app, website admin, dokumentasi teknis, dan integrasi backend.",
    points: [
  ...
  },
  {
    ...
    stack: ["Camunda", "Java", "BPMN", "Website"],
    summary:
      "Pemodelan dan validasi alur proses bisnis menggunakan Camunda BPMN sebagai proyek skripsi.",
    points: [
  ...
  },
  {
    ...
    stack: ["Figma", "Website", "UI/UX Redesign", "Training"],
    summary:
      "Dukungan analisis, pelatihan, dan redesain UI/UX untuk implementasi aplikasi UG-SMART.",
    points: [
...
export const focusAreas: FocusArea[] = [
  {
    ...
    description:
      "Mengubah desain dan kebutuhan bisnis menjadi halaman yang konsisten, cepat dipahami, dan nyaman digunakan di desktop maupun mobile.",
    tools: ["HTML", "CSS", "Tailwind CSS", "Bootstrap", "Vue.js", "React.js"],
  },
  {
    title: "Integrasi Sistem",
    description:
      "Menghubungkan antarmuka dengan REST API, memetakan state, dan memastikan data tampil sesuai alur operasional pengguna.",
    tools: ["REST API", "Postman", "JavaScript", "PHP", "Node.js", "MySQL"],
  },
  {
    title: "Validasi Produk",
    description:
      "Menguji flow, memperbaiki bug, dan menyiapkan dokumentasi agar fitur lebih stabil saat digunakan tim maupun pengguna akhir.",
    tools: ["Testing", "User Guide", "Draw.io", "Trello", "Figma"],
  },
];
...
export const skills = [
  ...
  {
    title: "Back-End",
    tools: ["PHP", "Node.js", "REST API", "MySQL"],
  },
  {
    title: "Tools",
    tools: [
  ...
  {
    title: "AI Assisted",
    tools: ["ChatGPT", "Claude", "Codex", "Prompting", "Software Testing"],
  },
];

export const skillIcons = [
  { name: "React", icon: "/skills-optimized/react.webp" },
  { name: "TypeScript", icon: "/skills-optimized/ts.webp" },
  { name: "JavaScript", icon: "/skills-optimized/js.webp" },
  { name: "Tailwind CSS", icon: "/skills-optimized/tailwind.webp" },
  { name: "Figma", icon: "/skills-optimized/figma.webp" },
  { name: "MySQL", icon: "/skills-optimized/mysql.webp" },
  { name: "HTML", icon: "/skills-optimized/html.webp" },
  { name: "CSS", icon: "/skills-optimized/css.webp" },
  { name: "Node.js", icon: "/skills-optimized/node.webp" },
];
